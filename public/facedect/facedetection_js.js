  ...
  vid.onplaying = function () {
    ...
    $('#download_image_button').click(function () {
      ...
      new Promise(function (fulfill, reject) {
        ...
        $("#faces_view").attr("style", "height:100%;width:100%;background-color:white;overflow-y:scroll;overflow-x:hidden;right: 0;left: 0;margin-right: auto;margin-left: auto;text-align: center")
